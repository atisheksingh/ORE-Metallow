    ...
    <div>
        ...
        <nav className="navbar navbar-expand-lg navbar-light">
          <div className="container-fluid alignment">
            <a className="navbar-brand" href="/">
              ...
              <a className ="section hero-sec"style= {styleObj}> MetAlloW</a>
              </div>
            </a>
          </div>
        </nav>
      ...
      <main className="hero-main">
        <section className="section hero-sec">
          <div className="container-fluid alignment" style={styleObj1}>
            <div className="row align-items-center" style={styleObj1}>
              <div className="col-xl-6 col-md-12">
                <h1  style={{color: "#D1D94D",textShadow:"-27px 4px 10px rgba(209, 217, 77, 0.9);"}}>ORE Initial Coin Offering.</h1>
                <p style={{color: "white"}}>
                  {" "}
                  Metal pegged cryptocurrency from soil Ecosystem.
                </p>
                <div className="hero-btns d-flex align-items-center">
                  <a style={{color:"white"}} href="/" className="m-btn btn--primary">
                    WHITEPAPER
                  </a>
                  <button
                    style={{color:"white"}}
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <div className="modal-bottom-input-txt">
                ...
                <h6 className="dark-font">10 USDC per ORE</h6>
              </div>
            </div>
